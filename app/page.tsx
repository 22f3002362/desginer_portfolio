...
const photographs = [
  ...
  },
  {
    title: "Campus Deer",
    category: "Wildlife",
    image: "/images/photography/deer.jpg",
  },
  {
    title: "Boat Nirvana ",
    category: "Product",
...
function ImagePreview({ isOpen, onClose, imageSrc }) {
  return (
    <Dialog open={isOpen} onClose={onClose} className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg overflow-hidden shadow-lg max-w-3xl w-full">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-black bg-white rounded-full p-2 hover:bg-gray-200 transition"
        >
          <X className="w-6 h-6" />
        </button>
        <Image src={imageSrc} alt="Preview" width={800} height={600} className="object-contain w-full h-full" />
      </div>
    </Dialog>
  );
}
